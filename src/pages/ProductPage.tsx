...
interface ProductPageProps {
  productSelector: (state: RootState) => Product[]; // Selector for the product list
  title: string; // Title for the page (e.g., "Men's Products")
}

const ProductPage: React.FC<ProductPageProps> = ({ productSelector, title }) => {
